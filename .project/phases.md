...
|-------|------|--------|------|-----------|--------|
| 0 | Project Skeleton | `feat/0-project-skeleton` | [phase-0](docs/specs/phase-0-project-skeleton.md) | — | Not Started |
| 1 | Email Sync | `feat/1-email-sync` | [phase-1](docs/specs/phase-1-email-sync.md) | 0 | Not Started |
| 2 | Classification Pipeline | `feat/2-classification` | [phase-2](docs/specs/phase-2-classification.md) | 0 | Not Started |
| 3 | Text Extraction | `feat/3-text-extraction` | [phase-3](docs/specs/phase-3-text-extraction.md) | 2 | Not Started |
| 4 | Full-Text Search | `feat/4-fulltext-search` | [phase-4](docs/specs/phase-4-fulltext-search.md) | 3 | Not Started |
| 5 | Embeddings & Semantic Search | `feat/5-embeddings` | [phase-5](docs/specs/phase-5-embeddings.md) | 3 | Not Started |
| 6 | MCP Server | `feat/6-mcp-server` | [phase-6](docs/specs/phase-6-mcp-server.md) | 4, 5 | Not Started |
| 7 | Background Service | `feat/7-background-service` | [phase-7](docs/specs/phase-7-background-service.md) | 1, 2, 3 | Not Started |
| 8 | Avalonia UI & Installer | `feat/8-ui-installer` | [phase-8](docs/specs/phase-8-ui-and-installer.md) | 7 | Not Started |
| 9 | Folder Watching | `feat/9-folder-watching` | [phase-9](docs/specs/phase-9-folder-watching.md) | 2 | Not Started |
